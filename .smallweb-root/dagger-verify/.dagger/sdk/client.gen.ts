 ...
 * it can be uses as argument to call a exposed function.
 */
function ChangesetMergeConflictValueToName(value: ChangesetMergeConflict): string {
  switch (value) {
 ...
 * it can be properly used inside the module runtime.
 */
function ChangesetMergeConflictNameToValue(name: string): ChangesetMergeConflict {
  switch (name) {
    case "FAIL":
 ...
 * it can be uses as argument to call a exposed function.
 */
function ChangesetsMergeConflictValueToName(value: ChangesetsMergeConflict): string {
  switch (value) {
 ...
 * it can be properly used inside the module runtime.
 */
function ChangesetsMergeConflictNameToValue(name: string): ChangesetsMergeConflict {
  switch (name) {
    case "FAIL":
