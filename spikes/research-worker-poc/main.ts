  ...
  return {
    fetch: async (req: Request): Promise<Response> => {
      ...
      try {
        ...
        const listedTools = await callMcp(fetchImpl, mcpServerUrl, mcpBearerToken, sessionId, "tools/list", {})
        ...
        const note = `Worker confirmed ${issueIdentifier} against ${targetLabel}.`
        ...
        record.summary = `Recorded a scoped note for ${issueIdentifier} against ${targetLabel}.`
