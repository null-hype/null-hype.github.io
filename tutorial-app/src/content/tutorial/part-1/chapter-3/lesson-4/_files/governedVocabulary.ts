// Vendored from tutorial-app/src/lib/governedVocabulary.ts so this
// lesson's WebContainer sandbox can run against the exact same admitted
// listing reasonResolver.spec.ts validates against -- byte-for-byte the
// `admitted` listing pkl/GovernedVocabulary.pkl (in the tree to the left)
// declares in real Pkl.
