// Vendored from tutorial-app/src/lib/reasonResolver.ts so this lesson's
// WebContainer sandbox can run the exact same resolver
// tutorial-app/src/lib/reasonResolver.spec.ts validates, including
// resolveReasonLog -- the function ReasonResolverBridge.tsx (outside this
// sandbox, in the outer app) calls on every edit to
// governedVocabulary.json/grantState.json to drive the live preview.
