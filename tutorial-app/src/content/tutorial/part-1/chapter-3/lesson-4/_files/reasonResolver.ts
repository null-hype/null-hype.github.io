...
// WebContainer sandbox can run the exact same resolver reasonResolver.spec.ts
// (in tutorial-app/src/lib) validates, and the exact same resolver that
// produced reason-log.jsonl -- see this file's own spec test for the proof
// that file is this function's real output, not hand-typed prose.
