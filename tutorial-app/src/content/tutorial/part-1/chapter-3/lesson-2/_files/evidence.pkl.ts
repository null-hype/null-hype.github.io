/* Vendored from tk-evidence-exporter/ts/evidence.pkl.ts (schema v1.3.0) --
   there's no shared package boundary between the two repos yet, so this is
   a manual copy. Re-vendor by hand (`cp` the source file over this one)
   whenever Evidence.pkl's shape changes. */
